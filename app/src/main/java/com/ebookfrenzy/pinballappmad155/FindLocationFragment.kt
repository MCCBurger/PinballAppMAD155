 ...
 */
class FindLocationFragment : Fragment(R.layout.fragment_find_location) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        webviewLocation.loadUrl("https://pinside.com/pinball/map")
        webviewLocation.webViewClient = WebViewClient()
    }
    companion object {
        /**
